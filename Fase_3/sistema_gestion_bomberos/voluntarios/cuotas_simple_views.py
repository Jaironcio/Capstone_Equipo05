        ...
        try:
            ...
            if voluntario.email:
                try:
                    ...
                    if email_enviado:
                        print(f'[EMAIL] ✅ Comprobante enviado exitosamente a {voluntario.email}')
                    else:
                        print(f'[EMAIL] ❌ No se pudo enviar el comprobante')
                except Exception as e:
                    print(f'[EMAIL] ❌ ERROR al enviar email: {str(e)}')
                    import traceback
                    traceback.print_exc()
            else:
                print(f'[EMAIL] ⚠️ El voluntario NO tiene email configurado')
