...
class SistemaFinanzas {
    ...
    async guardarIngreso(datos) {
        ...
        const movimiento = {
            ...
            registradoPregistradoPor: JSON.parse(localStorage.getItem('currentUser')).username,
        ...
        return `
            <div class="movimiento-card ${tipoClass}">
                ...
                <div class="item-info">
                    ...
                    ${mov.detalle ? `
                        <div><strong>Detalle:</strong> <span>${mov.detalle}</span></div>
                    ` : ''}
                    
                    ${mov.numeroDocumento ? `
                        <div><strong>N° Documento:</strong> <span>${mov.numeroDocumento}</span></div>
                    ` : ''}
