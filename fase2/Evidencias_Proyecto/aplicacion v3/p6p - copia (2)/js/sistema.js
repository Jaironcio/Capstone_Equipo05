...
class SistemaBomberos {
  ...
  // En el archivo sistema.js

inicializarContadores() {
    // ⚠️ FUNCIÓN VACÍA: Delegamos la inicialización a storage.js.
    console.log('✅ Contadores sincronizados desde StorageManager (función de reinicio omitida).');
}
    async cargarDatos() {
