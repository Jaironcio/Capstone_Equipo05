...
class SistemaCuotasBeneficios {
    ...
    async guardarPagoCuota(datos) {
        ...
        const movimiento = {
            ...
            monto: parseFloat(datos.montoCuota),
            descripcion: `Cuota ${datos.tipoCuota} - ${this.bomberoActual ? Utils.obtenerNombreCompleto(this.bomberoActual) : 'Voluntario'} (${this.obtenerNombreMes(datos.mesCuota)}/${datos.anioCuota})`,
